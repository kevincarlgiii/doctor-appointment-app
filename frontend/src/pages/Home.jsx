    ...
    return (
        ...
        <section>
            <div className="container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 mt-[30px] lg:grid-cols-3 gap-5 lg:gap-[30px] lg:mt-[55px]">
                    <div className="py-[30px] px-5">
                        ...
                        <div className="mt-[30px]">
                            <h2 className="text-[26] leading-9 text-headingColor font-[700] text-center">
                                Find a Doctor
                            </h2>
                            ...
                            <Link to='/doctors' className="w-[44px] h-[44px] rounded-full 
                                ...
                                <BsArrowRight className="group-hover:text-white w-6 h5" />
                            </Link>
                        </div>
                    </div>
                ...
                <div className="flex items-center justify-between flex-col lg:flex-row">
                    ...
                    <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                        ...
                        <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 
                            z-20 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-[6px] lg:gap-3">
                                    <p className="text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor font-[600]">Tue, 24</p>
                                    <p className="text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-text-Color font-[400]">10:00AM</p>
                                </div>
                            ...
                            <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 
                                lg:py-[6px] lg:px-[10px] lg:mt-4 text-[8px] leading-[8px] 
