...
const socialLinks = [
    {
        path: "https://www.youtube.com/channel/UCv-mgtpsW_r8c0uplMuQ52A",
        icon: <AiFillYoutube className="group-hover:text-white w-4 h5"/>,
    },
    {
        path: "https://github.com/kevincarlgiii",
            ...
            <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
                <div>
                    ...
                    <p className="text-[16px] leading-7 font-[400] text-textColor">
                        Copyright © {year} developed by Kevin Carl Gunda, All rights reserved
                    </p>
