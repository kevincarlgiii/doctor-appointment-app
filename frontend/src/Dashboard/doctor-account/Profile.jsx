...
const Profile = ({ doctorData }) => {
    ...
    //reusable functions for adding items
            ...
            <form action="">
                ...
                <div className="mb-5">
                    <div className="grid grid-cols-3 gap-5 mb-[30px]">
                        ...
                        <div>
                            <p className="form__label">Consultation Fee*</p>
                            <input
                                type="number" 
                                placeholder="1000" 
                                name="ticketPrice" 
                ...
                <div className="mb-5">
                    ...
                    <button 
                        ...
                        className="bg-[#000] py-2 px-5 rounded 
                            text-white h-fit cursor-pointer">
                        Add Qualification
                    </button>
                </div>
                    ...
                    <div className="relative w-[130px] h-[50px]">
                        ...
                        <label htmlFor="customFile" 
                            className="absolute top-0 left-0 w-full h-full flex items-center 
                                px-[0.75rem] py-[0.375rem] text-[15px] leading-6 
                                overflow-hidden bg-[#0066FF46] text-headingColor
